...
import { getMockProduct } from "@/lib/mocks/admin";
    ...
    <div className="space-y-6 p-6">
      <header className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          <AdminActionDialog
            trigger={<Button variant="destructive">강제 내림</Button>}
            title="상품 강제 내림"
            description="판매 상태를 강제로 내림(withdrawn) 처리합니다."
            actionLabel="강제 내림"
            destructive
          ...
          {isAuctionOpen && (
            <AdminActionDialog
              ...
              title="경매 강제 종료"
              description="진행중 경매를 즉시 종료(낙찰/유찰 판정)합니다."
              actionLabel="강제 종료"
              tier={2}
            />
          )}
